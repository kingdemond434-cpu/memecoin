...
CANDIDATES: Tuple[Tuple[str, str, str, str, str], ...] = (
    ...
    ("decrypt-rss", "rss", "en", "global", "https://decrypt.co/feed"),
    ("blockworks-rss", "rss", "en", "global", "https://blockworks.co/feed"),
    ("cryptoslate-rss", "rss", "en", "global", "https://cryptoslate.com/feed/"),
    ("bitcoinmagazine-rss", "rss", "en", "global",
     "https://bitcoinmagazine.com/.rss/full/"),
    ("beincrypto-rss", "rss", "en", "global", "https://beincrypto.com/feed/"),
    ("cryptobriefing-rss", "rss", "en", "global",
     "https://cryptobriefing.com/feed/"),
    ("kraken-blog-rss", "rss", "en", "global", "https://blog.kraken.com/feed"),
    ("coinbase-blog-rss", "rss", "en", "us", "https://www.coinbase.com/blog/rss"),
    ("coinpost-rss", "rss", "ja", "jp", "https://coinpost.jp/?feed=rss2"),
    # Chain and protocol data.
    ("solana-status", "rss", "en", "global", "https://status.solana.com/history.rss"),
    ("jupiter-status", "rss", "en", "global", "https://status.jup.ag/history.rss"),
    ("helius-status", "rss", "en", "global", "https://status.helius.dev/history.rss"),
    ("coinbase-status", "rss", "en", "global", "https://status.coinbase.com/history.rss"),
    # Protocol/repository chronology. These are the projects' own public Atom
    # feeds, not scraped HTML or an authenticated GitHub API. Changes to the
    # execution stack can therefore enter the research ledger without a token
    # or an AI session.
    ("agave-commits", "rss", "en", "global",
     "https://github.com/anza-xyz/agave/commits/master.atom"),
    ("agave-releases", "rss", "en", "global",
     "https://github.com/anza-xyz/agave/releases.atom"),
    ("jito-solana-commits", "rss", "en", "global",
     "https://github.com/jito-foundation/jito-solana/commits/master.atom"),
    ("jito-solana-releases", "rss", "en", "global",
     "https://github.com/jito-foundation/jito-solana/releases.atom"),
    ("jito-relayer-commits", "rss", "en", "global",
     "https://github.com/jito-foundation/jito-relayer/commits/master.atom"),
    ("jito-searcher-examples", "rss", "en", "global",
     "https://github.com/jito-labs/searcher-examples/commits/master.atom"),
    ("raydium-sdk-commits", "rss", "en", "global",
     "https://github.com/raydium-io/raydium-sdk-V2/commits/master.atom"),
    ("orca-whirlpools-commits", "rss", "en", "global",
     "https://github.com/orca-so/whirlpools/commits/main.atom"),
    ("meteora-dlmm-commits", "rss", "en", "global",
     "https://github.com/MeteoraAg/dlmm-sdk/commits/main.atom"),
    ("jupiter-api-client-commits", "rss", "en", "global",
     "https://github.com/jup-ag/jupiter-swap-api-client/commits/main.atom"),
    ("solana-program-library-commits", "rss", "en", "global",
     "https://github.com/solana-labs/solana-program-library/commits/master.atom"),
