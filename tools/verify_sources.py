...
CANDIDATES: Tuple[Tuple[str, str, str, str, str], ...] = (
    ...
    ("hacker-news-new", "rss", "en", "global",
     "https://hacker-news.firebaseio.com/v0/newstories.json"),
    ("wikimedia-recentchange", "sse", "mul", "global",
     "https://stream.wikimedia.org/v2/stream/recentchange"),
    ("gdelt-doc", "gdelt", "mul", "global",
     "https://api.gdeltproject.org/api/v2/doc/doc?query=solana&mode=artlist&format=json&maxrecords=5"),
    ...
    ("pump-public-docs", "git", "en", "global",
